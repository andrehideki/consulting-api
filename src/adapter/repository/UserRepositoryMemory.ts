...
export class UserRepositoryMemory implements UserRepository {
    ...
    constructor(dataEncryptor: DataEncriptor) {
        ...
        */
        ...
        this.users.push(new User("admin@mail.com", "$2b$10$oBg7O3eWXww21N898Fbt3uVflWjLu2jb4H2mC8l78use7i1KipW/m", "ADMIN", dataEncryptor));
        this.users.push(new User("owner@mail.com", "$2b$10$QbdimKOXFWd7gOYrSVpK5uwwkzXCe9rNWVx8atZviqPnKiXbUpkLu", "OWNER", dataEncryptor));
    }
